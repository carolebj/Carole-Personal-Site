const en = {
  nav: {
    ...
    theme: "Choose theme",
    openTheme: "Open theme choices",
    closeTheme: "Close theme choices",
    ...
    serviceCategoryStrategy: "Strategy & direction",
    serviceCategoryContent: "Content & activation",
    serviceCategoryBrand: "Brand & design",
    serviceCategoryOther: "Other services",
    serviceDescriptionEditorial: "Define your editorial direction.",
    serviceDescriptionAudit: "Identify your next priorities.",
    serviceDescriptionCommunication: "Coordinate your digital presence.",
    serviceDescriptionContent: "Turn your ideas into content.",
    serviceDescriptionIdentity: "Build a consistent brand image.",
    serviceDescriptionOther: "Explore this service.",
    projectEstimator: "Estimate my project",
  ...
  servicesConstruction: {
    ...
    description:
      "The detailed service pages are being prepared. In the meantime, feel free to explore the rest of the site or contact me to discuss your needs.",
